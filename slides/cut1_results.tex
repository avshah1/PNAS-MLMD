...
\vspace{0.3cm}
{\color{accent!60!white}\hrule height 2pt}
\vspace{0.3cm}

{\color{white!80}\insertsubtitle}

\vspace{1.5cm}
{\color{white!70}\small\insertauthor\hspace{2cm}\insertdate}
\end{frame}
}
...
\begin{center}
\colorbox{accent!10}{%
\parbox{0.8\textwidth}{\centering\textbf{Result: They disagree.
...
\vspace{-0.3cm}
{\small\color{navy}\textbf{Brier score:}
$\hat{p}^{ML}_1 = 0.024$ vs $\hat{p}^{DA} = 0.060$.
ML is 2.5$\times$ more accurate.}
\end{frame}
